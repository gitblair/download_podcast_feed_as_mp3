...
$latest_episodes_table = [];
    ...
    if ($rss_content !== false) {
        ...
        $podcast_data_table = parse_rss_feed($rss_content, 1);
...
<a href="audioplayer.php?audiopath=<?php echo $episode['audio_url']; ?>">Phoar</a>
      <!-- Waveform Container -->
      <!-- <div id="waveform"></div> -->
      <!-- <div id="waveform-<?php echo $episode['id']; ?>" data-audio-url="<?php echo $episode['audio_url']; ?>"></div> -->

      <?php //echo $episode['audio_url']; ?>
